...
knitr::opts_chunk$set(
  ...
  fig.width = 9,
  fig.height = 4,
  fig.path = "result/02-Cluster-Marker/Analysis_plot/"
)
...
Idents(seurat_obj) <- seurat_obj$integrated_snn_res.0.5
# 2. Plot with split.by + ncol = 3
DimPlot(
  seurat_obj,
  reduction = "umap",
...
seurat_obj$seurat_clusters <- seurat_obj$integrated_snn_res.0.5
...
lapply(unique(cluster_marker$cluster), function(cl){
  ...
  openxlsx::write.xlsx(
    cell.type.annotation,
    file = sprintf("./result/02-Cluster-Marker/cell_type_annotation_resolution_%s.xlsx", res)
  )
...
<!-- Idents(seurat_obj) <- seurat_obj$seurat_clusters <- seurat_obj$integrated_snn_res.0.5 -->
