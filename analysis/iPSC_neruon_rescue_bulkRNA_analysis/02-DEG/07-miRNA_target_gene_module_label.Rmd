...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
 fig.path = "./results/rescue_target_gene_module_label/Analysis_figure/",
  fig.width = 8,
  fig.height = 6,
  dpi = 300,
  cache = FALSE,
...
## Sample 004
```{r miRNA_plot_128_004, fig.width=8, fig.height=8}
...
## Sample 004
```{r miRNA_plot_185_004, fig.width=8, fig.height=8}
