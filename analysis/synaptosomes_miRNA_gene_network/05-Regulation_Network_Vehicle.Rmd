...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/02-Regulation_Vehicle_v2/figures/"
)
...
```{r}
DEM <- read.csv(here::here("analysis", "synaptosomes_miRNA_anlaysis", "results", "01-DEM-Vehicle", "02-DEM", "01_all_gene_results.csv"), row.names = 1)
...
# 
# 
# write.csv(network_data, file.path("results", "02-Regulation_Vehicle_v2", "network_data.csv"), row.names = FALSE)
# 
...
result_folder <- "results/02-Regulation_Vehicle_v2/Up_pathways"
...
result_folder <- "results/02-Regulation_Vehicle_v2/Down_pathways"
...
for (miRNA_name in miRNA_list_DEM_up ){
  ...
  write.csv(enrich_result, file.path("results", "03-leaves", paste0(miRNA_name,"_up_enrichment_GO_BP.csv")))
...
for (miRNA_name in miRNA_list_DEM_down ){
  ...
  # save the result to csv
  write.csv(enrich_result, file.path("results", "03-leaves", paste0(miRNA_name,"_down_enrichment_GO_BP.csv")))
